...
<html lang="ko">
  ...
  <meta charset="utf-8">
    ...
    <style>
      ...
      #banner { font-size: min(6vw, 3.5em); display: block; background: center / cover no-repeat url("./banner.png"); width: 100%; height: 1.25em; color: white; margin-top: 0.5em; padding-top: 0.125em;}
    </style>
  </head>
  <body>
    <div class="jb-box">
